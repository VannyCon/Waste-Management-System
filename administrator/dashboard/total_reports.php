...
$unpaid = $conn->query($sql);

// Fetch records from tbl_enforcer_report, ordered by ID in ascending order
$sql2 = "SELECT `id`, `violationID`, `resident_name`, `violators_name`, `violators_age`, `violators_gender`, `violators_location`, `violation_type`, `datetime`, `latitude`, `longitude`, `penalty` 
        FROM `tbl_enforcer_report` 
        WHERE `isPaid` = 1
        ORDER BY `id` ASC";

$paid = $conn->query($sql2);
?>
    ...
    <div class="card">
                ...
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4><b class="text-danger">UNSOLVED</b></h4>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
                ...
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4><b class="text-success">SOLVED</b></h4>
                    </div>
                </div>
            </div>
                    ...
                    <table id="EnforcerReports" class="table table-striped table-responsive-sm" style="min-width: 845px">
                        <thead>
                            <tr>
                                ...
                                <th><b style="color: black;">Penalty</th>
                                <th><b style="color: black;">Evidence</th>
                                <th><b style="color: black;">Status</th>
                            </tr>
                        </thead>
                        <tbody class="text-dark">
                            <?php
